...
class AmazonAPI:
    ...
    def get_price(self):
        ...
        try:
            ...
            try:
                ...
                if 'In Stock' or 'in stock' in availability:
                    price = self.driver.find_element_by_class_name('a-size-base a-color-price').text
    ...
    def get_products_links(self):
        ...
        links = []
        try:
            results = result_list[0].find_elements_by_xpath('//*[@id="search"]/div[1]/div/div[1]/div/span[3]/div[2]/div/div/span/div/div/div[2]/div[2]/div/div[1]/h2/a')
